...
export const module5Lessons: Record<string, LessonData> = {
  "5.1": {
    ...
    clinicalImages: [
      {
        url: "https://www.youtube.com/embed/auG2nND0e7w",
        caption: "Video: Ultrasound Artifacts Explained"
      },
      {
