...
export const module14Lessons: Record<string, LessonData> = {
  ...
  "14.2": {
    title: "PACS & DICOM",
    narrationScript: "I read over 20 research papers and clinical guidelines for you so here is the cliffnotes version to save you 15 hours of unguided reading. A single textbook wasn't enough, so I aggregated everything into this ultimate guide.\n\nBut as per usual, it is not enough just to listen to me talk about stuff, so at the end of the video, there is a little assessment.\n\n**1. The Roadmap**\n• Part 1: Definitions (What even is Module 14 Topic?).\n• Part 2: Core Concepts/Crash Course.\n• Part 3: Practical Application.\n• Part 4: The \"Holy Sh*t\" Insight.\n\n**2. What it is NOT**\nThe easiest way to first define Module 14 Topic is the given example of what is not Module 14 Topic. It's not just basic imaging.\n\n**3. The Mnemonic**\nHere is a mnemonic in case you can't remember... just think about \"Cats Always Meow\".\n\n**4. Core Concepts / Crash Course**\nHere is what you need to know: Once you take the image, where does it go? In the old days, it was a physical film. Today, it's a server. PACS is your digital warehouse, and DICOM is the language that makes sure your GE machine can talk to your Philips workstation. This is the plumbing of the modern hospital.\n\n**5. The Analogy**\nThink of this system like a high-performance engine.\n\n**6. Practical Application**\nTo make this actually all practical, I'm going to show you how to apply this workflow which does not require any code.\n\n**7. The \"Holy Sh*t\" Insight**\nIf you master this, you can literally shave 10 minutes off every scan you do!\n\n**8. The Mindset Shift**\nYou do not rise to the level of your goals, you fall to the level of your systems. Use the 2-minute rule to build a habit of checking this first.\n\n**9. The Assessment**\nAs promised, here is a little assessment. If you can answer these questions then congratulations, you can consider yourself educated on Module 14 Topic. Drop your answers in the comments below!",
    content: (
      <div className="space-y-8 md:space-y-12 animate-in fade-in duration-1000">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
  ...
  "14.3": {
    ...
    narrationScript: "I read over 20 research papers and clinical guidelines for you so here is the cliffnotes version to save you 15 hours of unguided reading. A single textbook wasn't enough, so I aggregated everything into this ultimate guide.\n\nBut as per usual, it is not enough just to listen to me talk about stuff, so at the end of the video, there is a little assessment.\n\n**1. The Roadmap**\n• Part 1: Definitions (What even is Module 14 Topic?).\n• Part 2: Core Concepts/Crash Course.\n• Part 3: Practical Application.\n• Part 4: The \"Holy Sh*t\" Insight.\n\n**2. What it is NOT**\nThe easiest way to first define Module 14 Topic is the given example of what is not Module 14 Topic. It's not just basic imaging.\n\n**3. The Mnemonic**\nHere is a mnemonic in case you can't remember... just think about \"Cats Always Meow\".\n\n**4. Core Concepts / Crash Course**\nHere is what you need to know: The future is off-site. Cloud storage is changing how we handle massive datasets from 3D volumes and elastography. We'll look at the pros and cons of cloud-based PACS and how high-speed networking is finally catching up to the data demands of modern scanning.\n\n**5. The Analogy**\nThink of this system like a high-performance engine.\n\n**6. Practical Application**\nTo make this actually all practical, I'm going to show you how to apply this workflow which does not require any code.\n\n**7. The \"Holy Sh*t\" Insight**\nIf you master this, you can literally shave 10 minutes off every scan you do!\n\n**8. The Mindset Shift**\nYou do not rise to the level of your goals, you fall to the level of your systems. Use the 2-minute rule to build a habit of checking this first.\n\n**9. The Assessment**\nAs promised, here is a little assessment. If you can answer these questions then congratulations, you can consider yourself educated on Module 14 Topic. Drop your answers in the comments below!",
    content: (
      <div className="space-y-8 md:space-y-12 animate-in fade-in duration-1000">
