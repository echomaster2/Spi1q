...
const DEFAULT_DECK: Flashcard[] = [
  ...
  { front: "Identify the array type producing this blunted sector view of the liver/kidney.", back: "Curvilinear (Convex) Array", moduleId: "Transducers", isPictureCard: true, frontImage: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/23/Ultrasound_of_the_liver_and_right_kidney.jpg/800px-Ultrasound_of_the_liver_and_right_kidney.jpg", repetition: 0, interval: 0, easeFactor: 2.5, nextReview: Date.now() },
  { front: "Identify the array type producing this rectangular vascular scan.", back: "Linear Sequential Array", moduleId: "Transducers", isPictureCard: true, frontImage: "https://upload.wikimedia.org/wikipedia/commons/f/fa/Carotid_ultrasound.jpg", repetition: 0, interval: 0, easeFactor: 2.5, nextReview: Date.now() },
  ...
  // ARTIFACTS
  { front: "Identify this clinical finding: Anechoic void behind a hyperechoic gallstone.", back: "Posterior Acoustic Shadowing", moduleId: "Imaging Artifacts", isPictureCard: true, frontImage: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/25/Gallstone_on_ultrasound.jpg/800px-Gallstone_on_ultrasound.jpg", repetition: 0, interval: 0, easeFactor: 2.5, nextReview: Date.now() },
  { front: "Identify the artifact enhancing the signal behind this fluid-filled cyst.", back: "Acoustic Enhancement", moduleId: "Imaging Artifacts", isPictureCard: true, frontImage: "https://upload.wikimedia.org/wikipedia/commons/4/4b/Ultrasound_of_a_simple_breast_cyst.png", repetition: 0, interval: 0, easeFactor: 2.5, nextReview: Date.now() },
  { front: "Identify the artifact creating a duplicate liver above the diaphragm.", back: "Mirror Image Artifact", moduleId: "Imaging Artifacts", isPictureCard: true, frontImage: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Ultrasound_Mirror_artifact.jpg/320px-Ultrasound_Mirror_artifact.jpg", repetition: 0, interval: 0, easeFactor: 2.5, nextReview: Date.now() },
  { front: "Identify the reverberation artifact appearing as a tapering metallic 'V' shape.", back: "Comet Tail Artifact", moduleId: "Imaging Artifacts", isPictureCard: true, frontImage: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c8/Ultrasound_Comet_tail_artifact.jpg/640px-Ultrasound_Comet_tail_artifact.jpg", repetition: 0, interval: 0, easeFactor: 2.5, nextReview: Date.now() },
  ...
  { front: "Identify this finding: Pulse wave spectral envelope wrapping around the baseline.", back: "Aliasing", moduleId: "Doppler Effect", isPictureCard: true, frontImage: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/07/Aliasing_in_Doppler_ultrasound.jpg/640px-Aliasing_in_Doppler_ultrasound.jpg", repetition: 0, interval: 0, easeFactor: 2.5, nextReview: Date.now() },
